    ...
    section.innerHTML = `
        ...
        <div class="game-body">
          ...
          <div class="thanks">
            ...
            <p>Отдельной благодарности заслуживает мой личный штат тестировщиков - Польч и Серёжа, а также мой бывший студент (который уже совсем не студент, а ого-го разработчик) Ваня. Эти люди прошли игру больше раз, чем я при разработке. Они нашли баги, которые меня потом преследовали в кошмарах (если найдёте ещё баг, пожалуйста, просто скажите, что это фича).</p>
            <p>Полинусу также спасибо за её прекрасные идеи, без них Корж-Девелопер не был бы таким крутым.</p>
